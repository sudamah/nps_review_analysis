...
class LabelsToDataframe:
    ...
    def get_data_frame(self):
        ...
        df_final['about'] = corpus_list.get_keywords_phreses()
        # df_final['sentiment'] = sentiments_list.get_sentiment_classifier_model()
        df_final['topic'] = type_list.get_type_classifier_model(
            candidate_labels)

        print(df_final)
        print('-'*110)
        print(df_final.to_csv(
            "/home/heptagon/Desktop/nps_review_analysis/review_about.csv", index=False))
